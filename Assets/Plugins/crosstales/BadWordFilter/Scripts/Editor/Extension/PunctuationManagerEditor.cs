...
namespace Crosstales.BWF.EditorExtension
{
   ...
   public class PunctuationManagerEditor : Editor
   {
      ...
      private Crosstales.BWF.Manager.PunctuationManager _script;

      private string _inputText = "Come on, test me!!!!!!";
      ...
      {
         _script = (Crosstales.BWF.Manager.PunctuationManager)target;
